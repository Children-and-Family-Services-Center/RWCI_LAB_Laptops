...
cscript "C:\Windows\System32\Printing_Admin_Scripts\en-US\prndrvr.vbs" -a -m "Xerox WorkCentre 3615 V4 PS" -h "C:\Xerox_WorkCentre_3615" -i "C:\Apps\Xerox_WorkCentre_3615\XeroxPhaser3610_WC3615_PS.inf"
